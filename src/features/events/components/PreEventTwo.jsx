    ...
    <div className="relative min-h-screen w-full bg-[#2D1E16] text-[#FEF8E0] font-gordita selection:bg-[#985A27] selection:text-[#FEF8E0] flex flex-col justify-between overflow-x-clip">
      ...
      <main className="relative z-10 flex-grow w-full">
        ...
        <section className="relative w-full min-h-[640px] sm:min-h-[720px] lg:min-h-[820px] xl:min-h-[880px] flex items-center overflow-hidden">
          {/* Main Hero Container */}
          <div className="relative z-20 w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-[120px] pt-24 pb-16 sm:pt-28 sm:pb-24 lg:py-32 flex flex-col items-start">
            {/* Left Content Column */}
            <div className="flex flex-col items-start max-w-[560px] lg:max-w-[620px] z-20">
              ...
              <div className="flex flex-col mb-8 sm:mb-10">
                <h1
                  className="font-swung text-6xl sm:text-7xl md:text-8xl lg:text-[96px] xl:text-[104px] leading-[1.02] sm:leading-[1.05] text-[#FEF8E0] tracking-[0.03em] sm:tracking-[0.04em] mb-6 sm:mb-8"
                  style={{ fontFamily: "'Swung Note', 'SwungNote', cursive" }}
                >
                  Silent<br />Constellation
                </h1>

                <p className="font-gordita font-medium text-lg sm:text-xl lg:text-[20px] text-[#F4D97B] leading-snug mb-3 sm:mb-4">
                  Discovering connections, realizing our impact.
                </p>

                <p className="font-gordita text-sm sm:text-[15px] leading-relaxed text-[#FEF8E0]/70 max-w-[480px]">
              ...
              <div className="flex items-center gap-4 sm:gap-5">
                ...
                <button
                  ...
                  className="relative group w-[160px] h-[48px] flex items-center justify-center cursor-pointer active:scale-95"
                >
                  <svg
                    width="160"
                    height="48"
                  ...
                  <span className="relative z-10 font-semibold text-[15px] text-[#FEF8E0] group-hover:text-white transition-colors duration-200">
                    Get Your Tickets
                  </span>
                </button>
                ...
                >
                  ...
                  <span className="relative z-10 font-semibold text-[15px] text-[#985A27] group-hover:text-[#F4D97B] transition-colors duration-200">
                    Explore what’s on
                  </span>
                </button>
              </div>
          ...
          {/* Right Hero Mascot Graphic - Anchored to Bottom Right */}
          <img
            src={heroGraphic}
            alt="Silent Constellation Hero Artwork"
            className="absolute bottom-0 -right-6 sm:-right-10 md:-right-14 lg:-right-16 xl:-right-20 w-[340px] sm:w-[460px] md:w-[560px] lg:w-[660px] xl:w-[740px] max-w-none object-contain object-bottom pointer-events-none select-none z-10"
          />
        </section>
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <section className="relative w-full max-w-[1440px] mx-auto px-4 sm:px-8 py-20 sm:py-28 lg:py-36 flex justify-center">
          <motion.div
          ...
          >
            ...
            <div className="relative w-full max-w-[760px] min-h-[540px] md:h-[560px] flex flex-col justify-center items-center px-6 sm:px-[52px] py-10 sm:py-[53px]">
              ...
              {/* Overlapping Decorative Artwork (Top-Right Mushroom/Mycelium Cluster) */}
              <img
                src={cardDecor}
                alt=""
                aria-hidden="true"
                className="absolute -top-16 -right-6 sm:-top-20 sm:-right-8 lg:-top-24 lg:-right-10 w-[120px] sm:w-[155px] lg:w-[180px] h-auto pointer-events-none z-20 drop-shadow-xl select-none"
              />

              {/* Inner Content Block matching Figma width 654px and gap 35px */}
              <div className="relative z-10 w-full max-w-[654px] flex flex-col gap-6 sm:gap-[35px]">
                {/* Title */}
                <span className="font-swung text-sm sm:text-base tracking-[0.26em] uppercase text-[#985A27] text-left">
                  Beneath the Surface
                </span>

                {/* Narrative Paragraph - Rata Kanan Kiri (text-justify) */}
                <p className="font-essays text-lg sm:text-2xl lg:text-[27px] leading-[1.55] sm:leading-[1.6] text-[#4B2D22] text-justify">
                ...
                <div className="flex items-center justify-between gap-3 sm:gap-4 w-full">
                  <div className="h-[1px] bg-[#ADA983] flex-1 max-w-[130px]" />
                  <span className="font-gordita font-medium text-[11px] sm:text-[13px] tracking-[0.2em] uppercase text-[#985A27] text-center whitespace-nowrap">
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <section id="lineup" className="relative w-full max-w-[1440px] mx-auto px-4 sm:px-8 py-20 sm:py-28 text-center">
          {/* Section Header */}
          <div className="flex flex-col items-center gap-2 mb-12 sm:mb-16">
            <span className="font-gordita font-medium text-xs sm:text-sm tracking-[0.3em] uppercase text-[#FEF8E0]">
              The Lineup
            </span>
            <h2 className="font-swung text-4xl sm:text-5xl lg:text-[60px] text-[#FEF8E0] tracking-tight">
              What's on Pre-Event 2
            </h2>
          </div>

          {/* 3D Coverflow Carousel Container */}
          <div className="relative w-full max-w-[1140px] mx-auto h-[460px] sm:h-[510px] md:h-[550px] lg:h-[570px] flex items-center justify-center overflow-visible">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              {ACTIVITIES.map((activity, index) => {
                ...
                const getXOffset = () => {
                  ...
                  if (diff === 0) return 0
                  if (diff === -1) return isMobile ? -95 : isTablet ? -145 : -180
                  if (diff === 1) return isMobile ? 95 : isTablet ? 145 : 180
                  if (diff === -2) return isMobile ? -180 : isTablet ? -270 : -350
                  if (diff === 2) return isMobile ? 180 : isTablet ? 270 : 350
                  return 0
                }
                ...
                const opacity = isCenter ? 1 : isAdjacent ? 0.9 : 0.75
                ...
                return (
                  <motion.div
                    ...
                    className={`absolute w-[260px] sm:w-[310px] md:w-[340px] lg:w-[360px] h-[400px] sm:h-[460px] md:h-[500px] lg:h-[520px] rounded-[24px] sm:rounded-[28px] overflow-hidden shadow-[0_20px_45px_rgba(0,0,0,0.55)] cursor-pointer select-none ${
                  ...
                  >
                    ...
                    {isCenter ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/35 via-35% to-transparent pointer-events-none" />
                    ) : (
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6 lg:p-7 flex flex-col justify-end text-left z-10">
                      <h3
                        className={`font-swung uppercase tracking-wide leading-tight mb-2 sm:mb-2.5 text-lg sm:text-xl md:text-[22px] lg:text-[25px] transition-colors duration-300 ${
          ...
          <div className="flex items-center justify-center gap-6 mt-8 sm:mt-10">
            ...
            <button
              ...
              className="w-11 h-11 rounded-full bg-[#FEF8E0] hover:bg-white text-[#2D1E16] flex items-center justify-center shadow-lg transition-transform duration-200 active:scale-90"
            >
              <img src={carouselNavIcon} alt="Previous" className="w-4 h-4" />
            </button>
                ...
                return (
                  <button
                    ...
                    className={`transition-all duration-300 rounded-full ${
                      isActive
                        ? 'w-7 h-2.5 bg-[#FEF8E0]'
                        : 'w-2.5 h-2.5 bg-[#FEF8E0]/20 hover:bg-[#FEF8E0]/50'
                    }`}
                  />
                )
              })}
            ...
            <button
              ...
              className="w-11 h-11 rounded-full bg-[#FEF8E0] hover:bg-white text-[#2D1E16] flex items-center justify-center shadow-lg transition-transform duration-200 active:scale-90"
            >
              <img src={carouselNavIcon} alt="Next" className="w-4 h-4 rotate-180" />
            </button>
          </div>
        </section>
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <section id="schedule" className="relative w-full max-w-[1440px] mx-auto px-4 sm:px-8 py-20 sm:py-28 text-center">
          {/* Header */}
          <div className="flex flex-col items-center gap-2 mb-12 sm:mb-16">
            <span className="font-gordita font-medium text-xs sm:text-sm tracking-[0.3em] uppercase text-[#FEF8E0]">
              Save the moment
          ...
          <div className="flex flex-col lg:flex-row items-stretch justify-center gap-8 lg:gap-10 max-w-[1040px] mx-auto">
            ...
            <motion.div
              ...
              className="flex-1 w-full max-w-[500px] mx-auto bg-[#FEF8E0] text-[#4B2D22] rounded-[24px] p-6 sm:p-8 border border-[#ADA983]/40 shadow-[0px_8px_24px_0px_rgba(75,45,34,0.14)] flex flex-col justify-between text-left"
            >
              {/* Header Row */}
              <div className="flex items-center justify-between gap-4">
                <div className="flex flex-col gap-1">
                  <span className="font-gordita font-bold text-xs tracking-[0.1em] uppercase text-[#985A27]">
                    Mark your calendar
                  </span>
                  <span className="font-swung text-2xl sm:text-[28px] text-[#4B2D22]">
                    October 2026
                  </span>
                </div>

                {/* Highlighted Date Badge */}
                <div className="bg-[#985A27] text-[#FEF8E0] rounded-[16px] px-4 py-2 flex flex-col items-center justify-center min-w-[66px] shadow-sm">
                  <span className="font-swung text-2xl sm:text-3xl leading-none">
                    24
                  </span>
                  <span className="font-swung text-[10px] tracking-[0.1em] uppercase mt-0.5">
                    Sat
                  </span>
                </div>
              </div>
              ...
              <div className="mt-6 bg-[#985A27]/10 rounded-[12px] p-3.5 sm:p-4">
            ...
            <motion.div
              ...
              className="flex-1 w-full max-w-[500px] mx-auto bg-[#FEF8E0] text-[#4B2D22] rounded-[24px] p-2.5 sm:p-3 border border-[#ADA983]/40 shadow-[0px_8px_24px_0px_rgba(75,45,34,0.14)] flex flex-col justify-between text-left"
            >
              {/* Venue Photograph */}
              <div className="relative w-full h-[240px] sm:h-[275px] rounded-[20px] overflow-hidden">
                <img
                  src={venueImg}
              ...
              <div className="p-3 sm:p-4 flex flex-col justify-between flex-grow gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <h3 className="font-swung text-2xl sm:text-[28px] text-[#4B2D22]">
                ...
                <a
                  ...
                  className="w-full h-[52px] bg-[#4B2D22] hover:bg-[#382017] text-[#FEF8E0] rounded-[16px] flex items-center justify-center gap-2.5 transition font-gordita font-bold text-sm sm:text-base shadow-sm group active:scale-[0.98]"
                >
                  <img src={mapsIcon} alt="" aria-hidden="true" className="w-4 h-4" />
        ...
        <section
          id="tickets"
          className="relative w-full bg-[#985A27] text-[#FEF8E0] py-24 sm:py-32 px-4 sm:px-8 text-center selection:bg-[#FEF8E0] selection:text-[#4B2D22]"
        >
          ...
          <div className="relative z-20 max-w-[640px] mx-auto flex flex-col items-center gap-4 select-text">
            <h2 className="font-swung text-4xl sm:text-5xl lg:text-[60px] text-[#FEF8E0] leading-tight tracking-tight select-text cursor-text">
              Get your ticket now!
            </h2>
            <p className="font-gordita text-base sm:text-lg text-[#FEF8E0]/90 leading-relaxed max-w-[512px] select-text cursor-text">
            ...
            <Link
              to="/coming-soon"
              className="relative group mt-8 w-full max-w-[524px] h-[120px] sm:h-[158px] flex items-center justify-center transition-transform duration-300 hover:scale-[1.02] active:scale-95"
            >
              {/* Notched Ticket SVG */}
              <svg
                width="524"
              ...
              {/* Button Typography */}
              <span className="relative z-10 font-swung text-3xl sm:text-4xl lg:text-[49px] text-[#FEF8E0] group-hover:text-[#F4D97B] transition-colors">
                Buy tickets!
              </span>
            </Link>
          </div>
